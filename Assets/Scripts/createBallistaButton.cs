...
public class createBallistaButton : MonoBehaviour
{
    ...
    public void selectBallista(){
        if(tileManager.GetComponent<TileManager>().selectedBlock != null && startTower.GetComponent<startTower>().money >= cost){
            ...
            ballistaClone.transform.SetParent(selectedBlock.transform, true);
